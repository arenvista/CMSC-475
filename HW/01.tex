...
\[
	\begin{gathered}
		...
		= \left[ \begin{array}{ccc}
				1 \cdot 1 + 10 \cdot (-1), & 1 \cdot 0 + 10 \cdot 0, & 1 \cdot 1 + 10 \cdot (-1) \\
				2 \cdot 1 + 20 \cdot (-1), & 2 \cdot 0 + 20 \cdot 0, & 2 \cdot 1 + 20 \cdot (-1) \\
				3 \cdot 1 + 30 \cdot (-1), & 3 \cdot 0 + 30 \cdot 0, & 3 \cdot 1 + 30 \cdot (-1)
			\end{array} \right]
		= \begin{bmatrix}
			-9  & 0 & -9  \\
			-18 & 0 & -18 \\
